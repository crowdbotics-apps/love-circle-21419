"""love_circle_21419 URL Configuration
...
admin.site.site_header = "Love Circle"
admin.site.site_title = "Love Circle Admin Portal"
admin.site.index_title = "Love Circle Admin"

# swagger
api_info = openapi.Info(
    title="Love Circle API",
    default_version="v1",
    description="API documentation for Love Circle App",
)
